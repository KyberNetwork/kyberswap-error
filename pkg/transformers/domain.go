...
func initDomainTransformerInstance() {
	if domainTransformerInstance == nil {
		...
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPRequired, errors.NewDomainErrorRequired)
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPNotAcceptedValue, errors.NewDomainErrorNotAcceptedValue)
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPOutOfRange, errors.NewDomainErrorOutOfRange)
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPInvalidFormat, errors.NewDomainErrorInvalidFormat)
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPInvalid, errors.NewDomainErrorInvalid)
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPUnauthenticated, errors.NewDomainErrorUnauthenticated)
		...
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPDuplicate, errors.NewDomainErrorDuplicate)
		domainTransformerInstance.RegisterTransformFunc(c.InfraErrCodeHTTPAlreadyExists, errors.NewDomainErrorAlreadyExits)
